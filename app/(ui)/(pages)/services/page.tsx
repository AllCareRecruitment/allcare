    ...
    const jobCards = [
        {
            ...
            description:
                ...
                ' Mi at fermentum imperdiet velit magna a aliquam. Faucibus et quam ac elit' +
        ...
        },
        {
            ...
            description:
                'Lorem ipsum dolor sit amet consectetur. Turpis sed pulvinar sed blandit rhoncus tellus senectus at quis.' +
                ' Mi at fermentum imperdiet velit magna a aliquam. Faucibus et quam ac elit placerat' +
                ' tristique vulputate.',
            bgColor: '#E9E7B3',
        },
        {
            ...
            description:
                ...
                'Turpis sed pulvinar sed blandit rhoncus tellus senectus at quis. ' +
                'Mi at fermentum imperdiet velit magna a aliquam. Faucibus et quam ac elit placerat ' +
                'tristique vulputate.',
            bgColor: '#A2A276',
        },
                ...
                <section className="max-w-4xl mx-auto px-12 pt-12">
                    <div className="flex flex-col md:flex-row items-start gap-12">
                        ...
                        <div className="md:w-1/3 relative">
                            ...
                            flex justify-center transform translate-y-1/2">
            ...
            <div className="bg-[#F0EAE3]">
                <section className="max-w-4xl mx-auto px-6 pt-6 pb-8 space-y-4">
                    {jobCards.map((job, index) => 
                        <div key={index} className="relative" style={{ backgroundColor: job.bgColor }}>
                            <div className="p-6">
