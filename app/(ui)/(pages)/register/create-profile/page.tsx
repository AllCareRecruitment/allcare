        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm text-black focus:ring-gray-500 focus:border-gray-500"
          ...
          <button
            type="submit"
            className="mt-4 w-full bg-[#6a5d3c] text-white py-2 px-4 rounded-md hover:bg-[#5a4d32] transition flex items-center justify-center gap-2 font-semibold shadow-md border border-[#5a4d32]"
            disabled={loading}
          >
